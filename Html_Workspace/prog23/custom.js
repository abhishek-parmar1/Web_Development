...
window.onload = function(){
    ...
    $('.song1').text(song_arr[0]);
    $('.song2').text(song_arr[1]);
    $('.song3').text(song_arr[2]);
    $('.song4').text(song_arr[3]);
    updateCurrentTime();
}
...
$('.fourth').on('click',function(){
   ...
   if(currentSong.search(song_arr[4]) != -1)
        {
            toggleSong();
        }
    else
...
/*
addSongNameEventListener("song1.mp3",0);
addSongNameEventListener("song2.mp3",1);
addSongNameEventListener("song3.mp3",2);
addSongNameEventListener("song4.mp3",3);
*/

for(var i = 0;i < song_arr.length;i++)
    {
        addSongNameEventListener(song_arr[i],i);
    }
